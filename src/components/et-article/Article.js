        ...
        <article className="post-card post tag-themes no-image">
          <div className="post-card-content">
            ...
            <header className="post-card-header">
              <span className="post-card-tags">{this.props.obj.theme}</span>
              <h2 className="post-card-title">{this.props.obj.title}</h2>
            </header>
            ...
            <footer className="post-card-meta">
              <img className="author-profile-image" src={this.props.obj.avator} alt="John O'Nolan" />
              <span className="post-card-author"><a href="/author/john/">{this.props.obj.author}</a></span>
            </footer>
          </div>
        </article>
      );
